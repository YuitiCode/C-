...
inline string Name::getValue() const{
    return value;
}
...
inline string Email::getValue() const{
    return value;
}
///
...
inline string Password::getValue() const{
    return value;
}
///
...
inline string Language::getValue() const{
    return value;
}
///
...
inline string Date::getValue() const{
    return value;
}
///
...
inline string Description::getValue() const{
    return value;
}
///
...
inline string City::getValue() const{
    return value;
}
///
...
inline string Country::getValue() const{
    return value;
}
///
...
inline int Note::getValue() const{
    return value;
}
#endif
