...
class Name{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso o nome nao esteja de acordo com as regras de formato
        ///
        /// @param valor nome
        ///
...
/// - Cada termo � composto por ate 63 caracteres
...
class Email{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso o email nao esteja de acordo com as regras de formato
        ///
        /// @param value email
        ///
        /// @throw invalid_argument
...
class Password{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso a senha nao esteja de acordo com as regras de formato
        ///
        /// @param valor senha
        ///
        /// @throw invalid_argument
...
///
/// - Idiomas disponiveis: Ingl�s, Chin�s, Mandarim, Hindi, Espanhol, Franc�s, �rabe, Bengali, Russo, Portugu�s, Indon�sio;
/// - Desconsiderar acentua�ao dos idiomas.
...
class Language{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso o idioma nao esteja de acordo com as regras de formato
        ///
        /// @param valor idioma
        ///
        /// @throw invalid_argument
...
class Date{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso a data nao esteja de acordo com as regras de formato
        ///
        /// @param valor data
        ///
        /// @throw invalid_argument
...
/// - Sem espa�os ou pontos em sequencia
...
class Description{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso a descricao nao esteja de acordo com as regras de formato
        ///
...
class Code{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso o codigo nao esteja de acordo com as regras de formato
        ///
        /// @param valor codigo
        ///
        /// @throw invalid_argument
...
class City{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso a cidade nao esteja de acordo com as regras de formato
        ///
        /// @param valor cidade
        ///
        /// @throw invalid_argument
...
///
/// - Paises disponiveis: Estados Unidos, Brasil, China, Coreia do Sul, Emirados, Fran�a, India, Japao, Malasia, Reino Unido, Tailandia, Turquia
...
class Country{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso o pais nao esteja de acordo com as regras de formato
        ///
        /// @param valor pais
        ///
        /// @throw invalid_argument
...
class Note{
    ...
    public:
        ...
        ///
        /// Lan�a exce��o caso a nota nao esteja de acordo com as regras de formato
        ///
        /// @param valor nota
        ///
        /// @throw invalid_argument
